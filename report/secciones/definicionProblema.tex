...
En esta sección se procederá a presentar una descripción general del problema \textit{Clique Cover} empezando con una explicación intuitiva seguido de su formulación formal, un ejemplo ilustrativo y algunas de sus aplicaciones mas relevantes. 

\subsection{Descripción en lenguaje natural}

El problema de \textit{Clique Cover} tiene como propósito dividir los vértices de los grafos en tantos subconjuntos como sea posible, de tal manera de que cada subconjunto sea un clique. Es decir, todos los vértices del mismo están relacionados entre sí.

De manera intuitiva, el objetivo seria entonces dividir los vértices en subconjuntos totalmente compatibles, logrando además minimizar la cantidad total de subconjuntos.
